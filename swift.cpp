...
// Gateway stuff
bool InstallHTTPGateway(struct event_base *evbase,Address addr,size_t chunk_size, double *maxspeed, char *storagedir);
...
int main (int argc, char** argv)
{
    ...
    if (httpgw_enabled)
        InstallHTTPGateway(Channel::evbase,httpaddr,chunk_size,maxspeed,NULL);
    if (cmdgw_enabled)
